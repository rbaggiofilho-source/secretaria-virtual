...
import { getDashboard, type DashboardData, type Usuario } from '../lib/api'
...
export function Dashboard({ usuario, onLogout }: { usuario: Usuario; onLogout: () => void }) {
  ...
  return (
    <div className="app-shell">
      <Sidebar open={menuOpen} onClose={() => setMenuOpen(false)} usuario={usuario} onLogout={onLogout} docs={data?.documentosProximos.length ?? 0} />
